...
public class MyUtils {
    ...
    public static void storeLoginedUser(HttpSession session, User_haui loginedUser) {
        // Trên JSP có thể truy cập thông qua ${loginedUser}
        session.setAttribute("loginedUser", loginedUser);
    }
 
    // Lấy thông tin người dùng lưu trữ trong Session.
    public static User_haui getLoginedUser(HttpSession session) {
        User_haui loginedUser = (User_haui) session.getAttribute("loginedUser");
        return loginedUser;
    }
 
    // Lưu thông tin người dùng vào Cookie.
    public static void storeUserCookie(HttpServletResponse response, User_haui user) {
