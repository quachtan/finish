...
/**
 * Servlet implementation class Luitrangthongke
 */
@WebServlet("/Luitrangthongke")
public class Luitrangthongke extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Luitrangthongke() {
        super();
   ...
   Calendar dayN = Calendar.getInstance();
	...
	if (thu == 2) {
		dayN.add(Calendar.DAY_OF_YEAR,-8);
		dayCN=dayN.get(Calendar.YEAR) + "-" + (dayN.get(Calendar.MONTH) + 1) + "-" + (dayN.get(Calendar.DATE));
		dayN.add(Calendar.DAY_OF_YEAR,1);
		dayT2=dayN.get(Calendar.YEAR) + "-" + (dayN.get(Calendar.MONTH) + 1) + "-" + (dayN.get(Calendar.DATE));
		dayN.add(Calendar.DAY_OF_YEAR,1);
	...
	if (thu == 3) {
		...
		dayN.add(Calendar.DAY_OF_YEAR,-9);
		dayCN=dayN.get(Calendar.YEAR) + "-" + (dayN.get(Calendar.MONTH) + 1) + "-" + (dayN.get(Calendar.DATE));
		dayN.add(Calendar.DAY_OF_YEAR,1);
		dayT2=dayN.get(Calendar.YEAR) + "-" + (dayN.get(Calendar.MONTH) + 1) + "-" + (dayN.get(Calendar.DATE));
		dayN.add(Calendar.DAY_OF_YEAR,1);
	...
	if (thu == 4) {
		...
		dayN.add(Calendar.DAY_OF_YEAR,-10);
		dayCN=dayN.get(Calendar.YEAR) + "-" + (dayN.get(Calendar.MONTH) + 1) + "-" + (dayN.get(Calendar.DATE));
		dayN.add(Calendar.DAY_OF_YEAR,1);
		dayT2=dayN.get(Calendar.YEAR) + "-" + (dayN.get(Calendar.MONTH) + 1) + "-" + (dayN.get(Calendar.DATE));
		dayN.add(Calendar.DAY_OF_YEAR,1);
	...
	if (thu == 5) {
		...
		dayN.add(Calendar.DAY_OF_YEAR,-11);
		dayCN=dayN.get(Calendar.YEAR) + "-" + (dayN.get(Calendar.MONTH) + 1) + "-" + (dayN.get(Calendar.DATE));
		dayN.add(Calendar.DAY_OF_YEAR,1);
		dayT2=dayN.get(Calendar.YEAR) + "-" + (dayN.get(Calendar.MONTH) + 1) + "-" + (dayN.get(Calendar.DATE));
		dayN.add(Calendar.DAY_OF_YEAR,1);
	...
	if (thu == 6) {
		...
		dayN.add(Calendar.DAY_OF_YEAR,-12);
		dayCN=dayN.get(Calendar.YEAR) + "-" + (dayN.get(Calendar.MONTH) + 1) + "-" + (dayN.get(Calendar.DATE));
		dayN.add(Calendar.DAY_OF_YEAR,1);
		dayT2=dayN.get(Calendar.YEAR) + "-" + (dayN.get(Calendar.MONTH) + 1) + "-" + (dayN.get(Calendar.DATE));
		dayN.add(Calendar.DAY_OF_YEAR,1);
	...
	if (thu == 7) {
		...
		dayN.add(Calendar.DAY_OF_YEAR,-13);
		dayCN=dayN.get(Calendar.YEAR) + "-" + (dayN.get(Calendar.MONTH) + 1) + "-" + (dayN.get(Calendar.DATE));
		dayN.add(Calendar.DAY_OF_YEAR,1);
		dayT2=dayN.get(Calendar.YEAR) + "-" + (dayN.get(Calendar.MONTH) + 1) + "-" + (dayN.get(Calendar.DATE));
		dayN.add(Calendar.DAY_OF_YEAR,1);
